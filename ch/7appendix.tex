...
\begin{figure}[hbt!] 
    \centering
    \includegraphics[width=0.75\linewidth]{table_scenarios_comp.png}
    \caption{Caption}
    \label{fig:TableTimecomparison}
\end{figure}

\begin{figure} [hbt!]
  \centering
  \subfloat[Simulations ]{\includegraphics[width=0.47 \linewidth]{images/WinnerNet1210.png} \label{fig:WRF_Winner_start}}
  \hfill
  \subfloat[TopTen ] {\includegraphics[width=0.47\linewidth]{images/WinnerNet13.png} \label{fig:WRF_Winner_End}}
  \caption{Wind Field from race measurements and WRF wind field at 12:10 hrs.}
\label{fig:WRFpathCompWinner}
\end{figure}


\begin{figure} [hbt!]
  \centering
  \subfloat[Simulations ]{\includegraphics[width=0.47 \linewidth]{images/WinnerSap1210.png} \label{fig:Sap_Winner_start}}
  \hfill
  \subfloat[TopTen ] {\includegraphics[width=0.47\linewidth]{images/WinnerSAP1300.png} \label{fig:Sap_Winner_End}}
  \caption{Wind Field from race measurements and WRF wind field at 12:10 hrs.}
\label{fig:SAPpathCompWinner}
\end{figure}

\begin{figure} [hbt!]
  \centering
  \subfloat[Simulations ]{\includegraphics[width=0.47 \linewidth]{images/PathCompScenarios.png} \label{fig:SimulationsPathsTraj}}
  \hfill
  \subfloat[TopTen ] {\includegraphics[width=0.47\linewidth]{images/Top3Comp.png} \label{fig:Top3Paths}}
  \caption{Wind Field from race measurements and WRF wind field at 12:10 hrs.}
\label{fig:PathSimulations_top3}
\end{figure}
